...
public class ObjectFactory {
    ...
    private static final QName _OpManagerResponse_QNAME = new QName("http://inhouse.productandservice/", "opManagerResponse");
    ...
    @XmlElementDecl(
        namespace = "http://inhouse.productandservice/",
        name = "opManagerResponse"
    )
